...
class TestAIGeneratorToolCalling:
    ...
    def mock_tool_manager(self):
        ...
        manager.execute_tool = Mock(return_value="Search result: Machine learning is a field of AI")
        return manager
    ...
    def test_generate_response_with_tool_definitions(self, ai_generator, sample_tool_definitions):
    ...
    def test_generate_response_triggers_tool_execution(self, ai_generator, sample_tool_definitions, mock_tool_manager):
        ...
        with patch.object(ai_generator.client.messages, 'create') as mock_create:
            ...
            second_response = MockResponse(
                stop_reason="end_turn",
                content=[MockContentBlock("text", text="Machine learning is a field of AI")]
            )
    ...
    def test_tool_execution_with_conversation_history(self, ai_generator, sample_tool_definitions, mock_tool_manager):
    ...
    def test_handle_tool_execution_formats_messages_correctly(self, ai_generator, mock_tool_manager):
        ...
        base_params = {
            "messages": [{"role": "user", "content": "Tell me about supervised learning"}],
        ...
        with patch.object(ai_generator.client.messages, 'create') as mock_create:
            mock_create.return_value = MockResponse(
                stop_reason="end_turn",
                content=[MockContentBlock("text", text="Supervised learning uses labeled data")]
            )
    ...
    def test_two_sequential_tool_calls(self, ai_generator, sample_tool_definitions, mock_tool_manager):
        ...
        with patch.object(ai_generator.client.messages, 'create') as mock_create:
            ...
            final_response = MockResponse(
                stop_reason="end_turn",
                content=[MockContentBlock("text", text="Machine learning uses neural networks for pattern recognition.")]
            )
    ...
    def test_max_rounds_enforced(self, ai_generator, sample_tool_definitions, mock_tool_manager):
        ...
        with patch.object(ai_generator.client.messages, 'create') as mock_create:
            ...
            final_response = MockResponse(
                stop_reason="end_turn",
                content=[MockContentBlock("text", text="Here's what I found based on searches.")]
            )
    ...
    def test_early_termination_after_one_round(self, ai_generator, sample_tool_definitions, mock_tool_manager):
        ...
        with patch.object(ai_generator.client.messages, 'create') as mock_create:
            ...
            final_response = MockResponse(
                stop_reason="end_turn",
                content=[MockContentBlock("text", text="Found the answer in first search.")]
            )
    ...
    def test_message_history_accumulates_correctly(self, ai_generator, sample_tool_definitions, mock_tool_manager):
